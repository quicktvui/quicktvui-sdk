 ...
 */
@ESKitAutoRegister
public class ESIJKAudioPlayerServiceModule implements IEsModule, IEsInfo {
    ...
    private ServiceConnection serviceConnection = new ServiceConnection() {
        ...
        public void onServiceDisconnected(ComponentName name) {
            ...
            EsProxy.get().sendNativeEventTraceable(ESIJKAudioPlayerServiceModule.this,
    ...
    private IPlayerCallback playerCallback = new IPlayerCallback.Stub() {
        ...
        public void onPlayerStatusChanged(int playerStatus) throws RemoteException {
            ...
            //成功
            if (playerStatus == PlayerStatusEnum.PLAYER_STATE_INITIALIZE_SUCCESS.ordinal()) {
                EsMap esMap = new EsMap();
                esMap.pushBoolean(EVENT_PROP_VALUE, true);
                EsProxy.get().sendNativeEventTraceable(ESIJKAudioPlayerServiceModule.this, Events.EVENT_ON_PLAYER_INIT.toString(), esMap);
            }
            //失败
            else if (playerStatus == PlayerStatusEnum.PLAYER_STATE_INITIALIZE_ERROR.ordinal()) {
                EsMap esMap = new EsMap();
                esMap.pushBoolean(EVENT_PROP_VALUE, false);
                EsProxy.get().sendNativeEventTraceable(ESIJKAudioPlayerServiceModule.this, Events.EVENT_ON_PLAYER_INIT.toString(), esMap);
            }
            ...
            EsProxy.get().sendNativeEventTraceable(ESIJKAudioPlayerServiceModule.this, Events.EVENT_ON_PLAYER_STATUS_CHANGED.toString(), esMap);
        }
    ...
    public void play2(String url, EsMap extraInfo) {
        try {
            if (serviceConnected && audioPlayerService != null) {
                ...
                ESAudioPlayerService.setExtraInfo(extraInfo);
