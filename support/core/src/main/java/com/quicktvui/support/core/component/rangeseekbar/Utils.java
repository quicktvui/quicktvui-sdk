...
public class Utils {
    ...
    public static Bitmap drawableToBitmap(Context context, int width, int height, Drawable drawableId) {
        if (context == null || width <= 0 || height <= 0 || drawableId == null) return null;
        return Utils.drawableToBitmap(width, height, drawableId);
    }
