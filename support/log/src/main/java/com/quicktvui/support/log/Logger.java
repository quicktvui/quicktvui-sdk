...
import com.quicktvui.support.log.internal.SystemCompat;
 ...
 * <p>
 * A {@link Logger} is always generated and mostly accessed by {@link ESLog}, but for customization
 * purpose, you can configure a {@link Logger} via the {@link Builder} which is returned by
 * {@link ESLog} when you trying to start a customization using {@link ESLog#tag(String)}
 ...
 * the {@link Logger} assuming that you are using the {@link ESLog} directly.
 */
public class Logger {
    ...
    public static class Builder {
         ...
         * it can be a package name like "eskit.sdk.support.log", a class name like "com.yourdomain.logWrapper",
         ...
         *                         "eskit.sdk.support.log", a class name like "com.yourdomain.logWrapper",
         *                         or something else between package name and class name, like "com.yourdomain.".
         *                         It is mostly used when you are using a logger wrapper
         * @param depth            the number of stack trace elements we should log, 0 if no limitation
         * @return the builder
