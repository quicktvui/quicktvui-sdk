...
package com.quicktvui.support.log.internal.util;
...
public class StackTraceUtil {
    ...
    private static final String ES_LOG_STACK_TRACE_ORIGIN;

    static {
        String esLogClassName = ESLog.class.getName();
        ES_LOG_STACK_TRACE_ORIGIN = esLogClassName.substring(0, esLogClassName.lastIndexOf('.') + 1);
    }
    ...
    /**
     * Get the real stack trace, all elements that come from ESLog library would be dropped.
     *
     * @param stackTrace the full stack trace
    ...
    private static StackTraceElement[] getRealStackTrack(StackTraceElement[] stackTrace,
        ...
        for (int i = allDepth - 1; i >= 0; i--) {
            ...
            if (className.startsWith(ES_LOG_STACK_TRACE_ORIGIN)
