...
import static com.quicktvui.support.log.ESLog.assertInitialization;
...
public class LogUtils {
    ...
    public static String formatJson(String json) {
        ...
        return ESLog.sLogConfiguration.jsonFormatter.format(json);
    }
    ...
    public static String formatXml(String xml) {
        assertInitialization();
        return ESLog.sLogConfiguration.xmlFormatter.format(xml);
    }
    ...
    public static String formatThrowable(Throwable throwable) {
        assertInitialization();
        return ESLog.sLogConfiguration.throwableFormatter.format(throwable);
    }
    ...
    public static String formatThread(Thread thread) {
        assertInitialization();
        return ESLog.sLogConfiguration.threadFormatter.format(thread);
    }
    ...
    public static String formatStackTrace(StackTraceElement[] stackTrace) {
        assertInitialization();
        return ESLog.sLogConfiguration.stackTraceFormatter.format(stackTrace);
    }
    ...
    public static String addBorder(String[] segments) {
        assertInitialization();
        return ESLog.sLogConfiguration.borderFormatter.format(segments);
    }
