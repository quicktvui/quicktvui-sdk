 ...
 * so if we setup a log level using <code>ESLog.init(...)</code>, all the logs which is with
...
public class LogLevel {
    ...
    /**
     * Log level for ESLog.v.
     */
    public static final int VERBOSE = 2;

    /**
     * Log level for ESLog.d.
     */
    public static final int DEBUG = 3;

    /**
     * Log level for ESLog.i.
     */
    public static final int INFO = 4;

    /**
     * Log level for ESLog.w.
     */
    public static final int WARN = 5;

    /**
     * Log level for ESLog.e.
     */
    public static final int ERROR = 6;

    /**
     * Log level for ESLog#init, printing all logs.
     */
    public static final int ALL = Integer.MIN_VALUE;

    /**
     * Log level for ESLog#init, printing no log.
     */
