...
import com.quicktvui.support.log.formatter.message.object.BundleFormatter;
import com.quicktvui.support.log.formatter.message.object.IntentFormatter;
...
import com.quicktvui.support.log.printer.ConsolePrinter;
...
public class Platform {
    ...
    static class Android extends Platform {
        ...
        @Override
        public void warn(String msg) {
            android.util.Log.w("ESLog", msg);
        }

        @Override
        public void error(String msg) {
            android.util.Log.e("ESLog", msg);
        }
    }
}
