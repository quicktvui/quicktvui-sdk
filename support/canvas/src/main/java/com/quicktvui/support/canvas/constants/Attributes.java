...
package com.quicktvui.support.canvas.constants;

import android.text.TextUtils;
import android.util.Log;

import com.quicktvui.support.canvas.render.DocAnimator;
import com.quicktvui.support.canvas.runtime.HapEngine;
import com.quicktvui.support.canvas.utils.CardThemeUtils;
...
public class Attributes {
    ...
    public static float getFloat(HapEngine hapEngine, Object value, float defValue) {
        ...
        try {
            ...
            if (temp.endsWith(Unit.PX)) {
                ...
                return DisplayUtil.getDesignPxByWidth(result, DisplayUtil.getScreenWidth(Utils.getApp()));
            }
    ...
    public interface PageAnimation {
        ...
        String SLIDE = "slide";
        //fade animation need to be defined at the standard conference
        String FADE = "fade";
        String NONE = "none";
    }
