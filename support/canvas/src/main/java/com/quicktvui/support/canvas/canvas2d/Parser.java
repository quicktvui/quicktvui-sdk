...
import com.quicktvui.support.canvas.Action;
import com.quicktvui.support.canvas.BuildConfig;
import com.quicktvui.support.canvas.CanvasImageLoadRenderAction;
import com.quicktvui.support.canvas.CanvasManager;
import com.quicktvui.support.canvas.CanvasRenderAction;
import com.quicktvui.support.canvas.CanvasSyncRenderAction;
import com.quicktvui.support.canvas.image.CanvasBitmap;
import com.quicktvui.support.canvas.image.CanvasImage;
import com.quicktvui.support.canvas.image.CanvasImageHelper;
import com.quicktvui.support.canvas.image.ImageData;
import com.quicktvui.support.canvas.utils.ColorUtil;
import com.quicktvui.support.canvas.utils.DisplayUtil;
import com.quicktvui.support.canvas.utils.FloatUtil;
import com.quicktvui.support.canvas.utils.IntegerUtil;
import com.quicktvui.support.canvas.utils.ThreadUtils;
...
public abstract class Parser {
    ...
    private static Map<Character, Parser> createRenderActions() {
        Map<Character, Parser> parsers = new HashMap<>();
        // 属性
        parsers.put('A', new Parser("fillStyle") {
            @Override
            public CanvasRenderAction parse(int pageId, int canvasId, char type, String parameter) {
                if (DEBUG) {
                ...
                switch (type) {
                    ...
                    case 'B': // pattern
                        ...
                        if (patternParams.length != 2) {
                            Log.e(TAG, "parse fillStyle pattern,invalid param,"
                    ...
                    case 'C': // linearGradient
                        ...
                        if (linearGradientParams.length < 4 || linearGradientParams.length % 2 != 0) {
                        ...
                        if (linearGradientParams.length > 4) {
                            for (int i = 4, length = linearGradientParams.length; i < length; i += 2) {
                                linearGradient.addColorStop(FloatUtil.parse(linearGradientParams[i]), ColorUtil.getColor(linearGradientParams[i + 1]));
                            }
                        }
                    ...
                    case 'D': // RadialGradient
                        ...
                        if (radialGradientParams.length < 6 || radialGradientParams.length % 2 != 0) {
                        ...
                        if (radialGradientParams.length > 6) {
                            for (int i = 6, length = radialGradientParams.length; i < length; i += 2) {
                                radialGradient.addColorStop(FloatUtil.parse(radialGradientParams[i]), ColorUtil.getColor(radialGradientParams[i + 1]));
                            }
                        }
        ...
        parsers.put('C', new NoTypeParser("globalAlpha", 1) {
            @Override
        ...
        parsers.put('D', new NoTypeParser("globalCompositeOperation", 1) {
            ...
            @Override
            public CanvasRenderAction parse(int pageId, int canvasId, String[] params, int num, String origin) {
        ...
        parsers.put('E', new NoTypeParser("lineCap", 1) {
            @Override
            public CanvasRenderAction parse(int pageId, int canvasId, String[] params, int num, String origin) {
        ...
        parsers.put('F', new NoTypeParser("lineDashOffset", 1) {
            @Override
            public CanvasRenderAction parse(int pageId, int canvasId, String[] params, int num, String origin) {
        ...
        parsers.put('G', new NoTypeParser("lineJoin", 1) {
            @Override
            public CanvasRenderAction parse(int pageId, int canvasId, String[] params, int num, String origin) {
        ...
        parsers.put('H', new NoTypeParser("lineWidth", 1) {
            @Override
            public CanvasRenderAction parse(int pageId, int canvasId, String[] params, int num, String origin) {
        ...
        parsers.put('I', new NoTypeParser("miterLimit", 1) {
            @Override
            public CanvasRenderAction parse(int pageId, int canvasId, String[] params, int num, String origin) {
        ...
        parsers.put('J', new NoTypeParser("shadowBlur", 1) {
            @Override
            public CanvasRenderAction parse(int pageId, int canvasId, String[] params, int num, String origin) {
        ...
        parsers.put('K', new NoTypeParser("shadowColor", 1) {
            @Override
            public CanvasRenderAction parse(int pageId, int canvasId, String[] params, int num, String origin) {
        ...
        parsers.put('L', new NoTypeParser("shadowOffsetX", 1) {
            @Override
            public CanvasRenderAction parse(
                    int pageId, int canvasId, String[] params, int num, String origin) {
        ...
        parsers.put('M', new NoTypeParser("shadowOffsetY", 1) {
            @Override
            public CanvasRenderAction parse(
                    int pageId, int canvasId, String[] params, int num, String origin) {
        ...
        parsers.put('N', new Parser("strokeStyle") {
            @Override
            public CanvasRenderAction parse(int pageId, int canvasId, char type, String parameter) {
                if (DEBUG) {
                ...
                switch (type) {
                    ...
                    case 'B': // pattern
                        ...
                        String[] patternParams = extractCommand(parameter);
                        if (patternParams.length != 2) {
                            Log.e(TAG, "parse strokeStyle pattern,invalid param,"
                                    +
                                    "specify an json array which length is 2, and index 0 is image id, "
                                    + " index 1 is pattern type!");
                            return null;
                    ...
                    case 'D': // RadialGradient
                        ...
                        RadialGradient radialGradient = new RadialGradient(m0, n0, r0, m1, n1, r1);
                        if (radialGradientParams.length > 6) {
        ...
        parsers.put('O', new NoTypeParser("textAlign", 1) {
            @Override
            public CanvasRenderAction parse(int pageId, int canvasId, String[] params, int num, String origin) {
        ...
        parsers.put('P', new NoTypeParser("textBaseline", 1) {
            @Override
            public CanvasRenderAction parse(
                    int pageId, int canvasId, String[] params, int num, String origin) {
        ...
        // 方法
        parsers.put('Q', new NoTypeParser("arc", 6) {
            @Override
            public Action parse(int pageId, int canvasId, String[] params, int num, String origin) {
                ...
                boolean anticlockwise = params[5].equals("true");
        ...
        parsers.put('R', new NoTypeParser("arcTo", 5) {
            @Override
            public CanvasRenderAction parse(
                    int pageId, int canvasId, String[] params, int num, String origin) {
        ...
        parsers.put('S', new Parser("beginPath") {
            @Override
            public CanvasRenderAction parse(int pageId, int canvasId, char type, String parameter) {
                if (DEBUG) {
                    Log.i(TAG, "beginPath");
        ...
        parsers.put('T', new NoTypeParser("bezierCurveTo", 6) {
            @Override
            public CanvasRenderAction parse(
                    int pageId, int canvasId, String[] params, int num, String origin) {
        ...
        parsers.put('U', new NoTypeParser("clearRect", 4) {
            @Override
            public CanvasRenderAction parse(int pageId, int canvasId, String[] params, int num, String origin) {
                float x = FloatUtil.parse(params[0]);
                float y = FloatUtil.parse(params[1]);
                ...
                if (FloatUtil.isUndefined(x) || FloatUtil.isUndefined(y) || FloatUtil.isUndefined(width) || FloatUtil.isUndefined(height)) {
                ...
                return new CanvasRenderAction(getName(), origin) {
                    ...
                    public boolean canClear(@NonNull CanvasContextRendering2D context) {
                        ...
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
                            region = context.getDesignDisplayRegion();
                        }
                        if (region == null) {
                            return false;
                        }
                        if (x <= region.left && y <= region.top && (x + width) >= region.right && (y + height) >= region.bottom) {
                            return true;
                        }

                        Bitmap bitmap = context.dumpBitmap();//todo 暂时不支持
                        if (bitmap == null) {
                            return false;
                        }
                        ...
                        return xTemp <= rect.left && yTemp <= rect.top && (xTemp + widthTemp) >= rect.right && (yTemp + heightTemp) >= rect.bottom;
                    }
        ...
        parsers.put('W', new Parser("closePath") {
            @Override
            public CanvasRenderAction parse(int pageId, int canvasId, char type, String parameter) {
                if (DEBUG) {
                    Log.i(TAG, "closePath:");
        ...
        parsers.put('X', new Parser("drawImage") {
            private CanvasContextRendering2D mCanvasContext;

            @Override
            public CanvasRenderAction parse(int pageId, int canvasId, char type, String parameter) {
                if (LogUtils.isDebug()) {
                    Log.d(TAG, "drawImage:" + parameter);
                }
                if (TextUtils.isEmpty(parameter)) {
                    return null;
                }
                ...
                switch (params.length) {
                    ...
                    case 5:
                        ...
                        x = Integer.parseInt(params[1]);
                        y = Integer.parseInt(params[2]);
                        sWidth = Integer.parseInt(params[3]);
                        sHeight = Integer.parseInt(params[4]);
                        data.pushString("url", url);
                        data.pushInt("x", x);
                        data.pushInt("y", y);
                        data.pushInt("sWidth", sWidth);
                        data.pushInt("sHeight", sHeight);
                        break;
                    case 9:
                        url = params[0];
                        id = url.hashCode();
                        ...
                        sWidth = Integer.parseInt(params[3]);
                        sHeight = Integer.parseInt(params[4]);
                        dx = Integer.parseInt(params[5]);
                        dy = Integer.parseInt(params[6]);
                        dWidth = Integer.parseInt(params[7]);
                        dHeight = Integer.parseInt(params[8]);
                        data.pushString("url", url);
                        data.pushInt("x", x);
                        data.pushInt("y", y);
                        data.pushInt("sWidth", sWidth);
                        ...
                        data.pushInt("dx", dx);
                        data.pushInt("dy", dy);
                        data.pushInt("dWidth", dWidth);
                        data.pushInt("dHeight", dHeight);
                        break;
                    default:
                        return null;
                }
                int finalX = x;
                int finalY = y;
                int finalSWidth = sWidth;
                int finalSHeight = sHeight;
                int finalDx = dx;
                int finalDy = dy;
                int finalDWidth = dWidth;
                int finalDHeight = dHeight;
                if (LogUtils.isDebug()) {
                    Log.d(TAG, "组装绘制数据");
                }
                return new CanvasImageLoadRenderAction(getName(), parameter) {
                    ...
                    public void render(@NonNull CanvasContextRendering2D context) {
                        ...
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
                            Set<Bitmap> originalSet = CanvasManager.getInstance().getBitmaps(pageId);
                            if (originalSet != null && originalSet.size() > 0) {
                                if (LogUtils.isDebug()) {
                                    Log.d(TAG, "绘制bitmap");
                                }
                                List<Bitmap> bitmapList = new ArrayList<>(originalSet);
                                for (Bitmap bitmap : bitmapList) {
                                    context.drawImage(bitmap, finalX, finalY, finalSWidth, finalSHeight, finalDx, finalDy, finalDWidth, finalDHeight);
                                    //CanvasManager.getInstance().deleteBitmapsByBitmap(bitmap); // 不会再抛异常
                                }
                                CanvasManager.getInstance().deleteBitmapsByPageId(pageId);
                            }
                        }
                    }
                };
        ...
        parsers.put('Z', new NoTypeParser("fillRect", 4) {
            @Override
            public CanvasRenderAction parse(int pageId, int canvasId, String[] params, int num, String origin) {
                float x = FloatUtil.parse(params[0]);
                float y = FloatUtil.parse(params[1]);
        ...
        parsers.put('a', new Parser("fillText") {
            @Override
            public Action parse(int pageId, int canvasId, char type, String parameter) {
                ...
                try {
                    /*if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
                        text = new String(Base64.decode(params[0], Base64.DEFAULT), StandardCharsets.UTF_8);
                    }*/
                    text = params[0];
                } catch (Exception e) {
                ...
                if (params.length == 4) {
                    ...
                    return new CanvasRenderAction(getName(), parameter) {
                        @Override
                        public void render(@NonNull CanvasContextRendering2D context) {
                            context.fillText(finalText, x, y, maxWidth);
                        }
                    };
                }
                ...
                return new CanvasRenderAction(getName(), parameter) {
                    @Override
                    public void render(@NonNull CanvasContextRendering2D context) {
                        context.fillText(finalText1, x, y);
                    }
                };
            }
        });
        parsers.put('b', new NoTypeParser("lineTo", 2) {
            @Override
            public CanvasRenderAction parse(int pageId, int canvasId, String[] params, int num, String origin) {
                float x = FloatUtil.parse(params[0]);
                float y = FloatUtil.parse(params[1]);
        ...
        parsers.put('c', new NoTypeParser("moveTo", 2) {
            @Override
            public CanvasRenderAction parse(int pageId, int canvasId, String[] params, int num, String origin) {
                float x = FloatUtil.parse(params[0]);
                float y = FloatUtil.parse(params[1]);
        ...
        parsers.put('d', new NoTypeParser("putImageData", 5) {
            @Override
            public CanvasRenderAction parse(
                    int pageId, int canvasId, String[] params, int num, String origin) {
                // 数据在js中进行裁剪
        ...
        parsers.put('e', new NoTypeParser("quadraticCurveTo", 4) {
            @Override
            public CanvasRenderAction parse(
                    int pageId, int canvasId, String[] params, int num, String origin) {
        ...
        parsers.put('f', new NoTypeParser("rect", 4) {
            @Override
            public CanvasRenderAction parse(
                    int pageId, int canvasId, String[] params, int num, String origin) {
                float x = FloatUtil.parse(params[0]);
        ...
        parsers.put('g', new Parser("restore") {
            @Override
            public CanvasRenderAction parse(int pageId, int canvasId, char type, String parameter) {
                if (DEBUG) {
        ...
        parsers.put('h', new NoTypeParser("rotate", 1) {
            @Override
            public CanvasRenderAction parse(
                    int pageId, int canvasId, String[] params, int num, String origin) {
        ...
        parsers.put('j', new NoTypeParser("scale", 2) {
            @Override
            public CanvasRenderAction parse(
                    int pageId, int canvasId, String[] params, int num, String origin) {
                float x = FloatUtil.parse(params[0]);
        ...
        parsers.put('k', new Parser("setLineDash") {
            @Override
            public CanvasRenderAction parse(int pageId, int canvasId, char type, String parameter) {
                if (DEBUG) {
        ...
        parsers.put('l', new NoTypeParser("setTransform", 6) {
            @Override
            public CanvasRenderAction parse(int pageId, int canvasId, String[] params, int num, String origin) {
        ...
        parsers.put('m', new Parser("stroke") {
            @Override
            public CanvasRenderAction parse(int pageId, int canvasId, char type, String parameter) {
                if (DEBUG) {
                    Log.i(TAG, "stroke");
        ...
        parsers.put('n', new NoTypeParser("strokeRect", 4) {
            @Override
            public CanvasRenderAction parse(int pageId, int canvasId, String[] params, int num, String origin) {
                float x = FloatUtil.parse(params[0]);
                float y = FloatUtil.parse(params[1]);
        ...
        parsers.put('o', new Parser("strokeText") {
            @Override
            public Action parse(int pageId, int canvasId, char type, String parameter) {
                if (DEBUG) {
                ...
                if (params.length == 4) {
                    float maxWidth = FloatUtil.parse(params[3]);
                    if (FloatUtil.isUndefined(maxWidth)) {
                        Log.e(TAG, "parse strokeText error,maxWidth is invalid," + parameter);
                        return null;
                    }
                    String finalText = text;
                    return new CanvasRenderAction(getName(), parameter) {
                        @Override
                        public void render(@NonNull CanvasContextRendering2D context) {
                            context.strokeText(finalText, x, y, maxWidth);
                        }
                    };
                }
                ...
                return new CanvasRenderAction(getName(), parameter) {
                    @Override
                    public void render(@NonNull CanvasContextRendering2D context) {
                        context.strokeText(finalText1, x, y);
                    }
                };
            }
        });
        parsers.put('p', new NoTypeParser("transform", 6) {
            @Override
            public CanvasRenderAction parse(int pageId, int canvasId, String[] params, int num, String origin) {
                float a = FloatUtil.parse(params[0]);
                float b = FloatUtil.parse(params[1]);
        ...
        parsers.put('q', new NoTypeParser("translate", 2) {
            @Override
            public CanvasRenderAction parse(int pageId, int canvasId, String[] params, int num, String origin) {
                float x = FloatUtil.parse(params[0]);
                float y = FloatUtil.parse(params[1]);
    ...
    private static Map<Character, Parser> createSyncRenderActions() {
        Map<Character, Parser> parsers = new HashMap<>();
        parsers.put('!', new NoTypeParser("measureText", 2) {
            @Override
            public Action parse(int pageId, int canvasId, String[] params, int num, String origin) {
                String text = "";
                try {
        ...
        parsers.put('@', new NoTypeParser("getImageData", 4) {
            @Override
                ...
                return new CanvasSyncRenderAction(getName()) {
                    ...
                    public void render(
                        ...
                        int screenWidth = DisplayUtil
                                .getScreenWidth(Utils.getApp());
                        int screenHeight = DisplayUtil
                                .getScreenHeight(Utils.getApp());
                        float width = sw;
                        float height = sh;
    ...
    //public abstract Action parse(int pageId, int canvasId, String parameter);
    ...
    public abstract static class NoTypeParser extends Parser {
        ...
        public abstract Action parse(int pageId, int canvasId, String[] params, int num, String origin);
    }
}
