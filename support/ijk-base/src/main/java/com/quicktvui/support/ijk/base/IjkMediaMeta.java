...
public class IjkMediaMeta {
    ...
    // stream: subtitle
    public static final String IJKM_KEY_SUB_TITLE = "subType";
    ...
    public static IjkMediaMeta parse(Bundle mediaMeta) {
        ...
        for (Bundle streamBundle : streams) {
            ...
            if (streamMeta.mType.equalsIgnoreCase(IJKM_VAL_TYPE__VIDEO)) {
                ...
                streamMeta.mTitle = streamMeta
                        .getString(IJKM_KEY_TITLE);
                ...
                streamMeta.mTitle = streamMeta
                        .getString(IJKM_KEY_TITLE);
                streamMeta.mSubType = streamMeta
                        .getInt(IJKM_KEY_SUB_TITLE);
            }
    ...
    public static class IjkStreamMeta {
        ...
        // subtitle
        public int mSubType; // 字幕类型：0 bitmap、1 text
