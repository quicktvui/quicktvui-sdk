...
public abstract class AbstractMediaPlayer implements IMediaPlayer {
    ...
    protected final boolean notifyOnInfo(int what, String extra) {
        return mOnInfoListener != null && mOnInfoListener.onInfo(this, what, extra);
    }
    ...
    protected final void notifyOnTimedBitmap(IjkTimedBitmap bitmap) {
        if (mOnTimedTextListener != null)
            mOnTimedTextListener.onTimedBitmap(this, bitmap);
    }
