...
public class IjkMediaCodecInfo {
    ...
    private static synchronized Map<String, Integer> getKnownCodecList() {
        ...
        sKnownCodecList.remove("OMX.MS.AVC.Decoder"); // 貌似不支持4k
...
//        sKnownCodecList.put("OMX.MS.AVC.Decoder", RANK_SOFTWARE);
    ...
    public static IjkMediaCodecInfo setupCandidate(MediaCodecInfo codecInfo,
        ...
        if (!name.startsWith("omx.") && !name.startsWith("c2.")) {
        ...
        } else if (name.startsWith("omx.pv.")) { // OMX.sprd.soft.
            rank = RANK_SOFTWARE;
            ...
            rank = RANK_NO_SENSE;
        } else if (name.startsWith("omx.mtk.") || name.startsWith("c2.mtk.")) {
