...
public class AndroidMediaPlayer extends AbstractMediaPlayer {
    ...
    public void setSpeed(float speed) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M && mInternalMediaPlayer != null) {
            PlaybackParams playbackParams = mInternalMediaPlayer.getPlaybackParams();
            playbackParams.setSpeed(speed);
            mInternalMediaPlayer.setPlaybackParams(playbackParams);
        }
    }
    ...
    public void selectTrack(int index) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN && mInternalMediaPlayer != null) {
    ...
    public void deselectTrack(int index) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN && mInternalMediaPlayer != null) {
            mInternalMediaPlayer.deselectTrack(index);
        }
    }
