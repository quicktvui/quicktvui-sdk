...
public class TVTextView extends TextView implements ITVView {
    ...
    public TVTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        onInitializeFromAttributes(attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public TVTextView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    protected void onInitializeFromAttributes( AttributeSet attrs){
        if(attrs != null) {
            ...
            TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.TVTextView);

            setFocusScale(typedArray.getFloat(R.styleable.TVTextView_value_focus_scale, TVFocusScaleExcuter.DEFAULT_SCALE));

            setFocusScaleX(typedArray.getFloat(R.styleable.TVTextView_value_focus_scaleX,mFocusScaleX));
            setFocusScaleY(typedArray.getFloat(R.styleable.TVTextView_value_focus_scaleY,mFocusScaleY));

            setupFloatFocusMargin(typedArray);

            setFloatFocusFocusedAlpha(typedArray.getFloat(R.styleable.TVTextView_float_focus_focused_alpha,1));

            setFocusScaleDuration(typedArray.getInt(R.styleable.TVTextView_duration_focus_scale, TVFocusScaleExcuter.DEFAULT_DURATION));
...
//        int left = typedArray.getDimensionPixelSize(R.styleable.FTextView_float_focus_marginLeft,0);
//        int right = typedArray.getDimensionPixelSize(R.styleable.FTextView_float_focus_marginRight,0);
//        int top = typedArray.getDimensionPixelSize(R.styleable.FTextView_float_focus_marginTop,0);
//        int bottom = typedArray.getDimensionPixelSize(R.styleable.FTextView_float_focus_marginBottom,0);

        int left = ConvertUtil.convertPixel(typedArray, R.styleable.TVTextView_float_focus_marginLeft, 0);
        int right = ConvertUtil.convertPixel(typedArray, R.styleable.TVTextView_float_focus_marginRight, 0);
        int top = ConvertUtil.convertPixel(typedArray, R.styleable.TVTextView_float_focus_marginTop, 0);
        int bottom = ConvertUtil.convertPixel(typedArray, R.styleable.TVTextView_float_focus_marginBottom, 0);
