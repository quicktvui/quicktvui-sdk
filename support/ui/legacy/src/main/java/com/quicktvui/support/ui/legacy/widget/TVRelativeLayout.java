...
public class TVRelativeLayout extends RelativeLayout implements ITVViewGroup, ITVFocusGroup {
    ...
    protected void onInitializeFromAttributes(AttributeSet attrs){
        if(attrs != null) {
            ...
            TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.TVRelativeLayout);

            setFocusScale(typedArray.getFloat(R.styleable.TVRelativeLayout_value_focus_scale, TVFocusScaleExcuter.DEFAULT_SCALE));

            setFocusScaleX(typedArray.getFloat(R.styleable.TVRelativeLayout_value_focus_scaleX,mFocusScaleX));
            setFocusScaleY(typedArray.getFloat(R.styleable.TVRelativeLayout_value_focus_scaleY,mFocusScaleY));

            setupFloatFocusMargin(typedArray);

            setFloatFocusFocusedAlpha(typedArray.getFloat(R.styleable.TVRelativeLayout_float_focus_focused_alpha,1));

            setFocusScaleDuration(typedArray.getInt(R.styleable.TVRelativeLayout_duration_focus_scale, TVFocusScaleExcuter.DEFAULT_DURATION));
...
//        int left = typedArray.getDimensionPixelSize(R.styleable.FRelativeLayout_float_focus_marginLeft,0);
//        int right = typedArray.getDimensionPixelSize(R.styleable.FRelativeLayout_float_focus_marginRight,0);
//        int top = typedArray.getDimensionPixelSize(R.styleable.FRelativeLayout_float_focus_marginTop,0);
//        int bottom = typedArray.getDimensionPixelSize(R.styleable.FRelativeLayout_float_focus_marginBottom,0);

        int left = ConvertUtil.convertPixel(typedArray, R.styleable.TVRelativeLayout_float_focus_marginLeft, 0);
        int right = ConvertUtil.convertPixel(typedArray, R.styleable.TVRelativeLayout_float_focus_marginRight, 0);
        int top = ConvertUtil.convertPixel(typedArray, R.styleable.TVRelativeLayout_float_focus_marginTop, 0);
        int bottom = ConvertUtil.convertPixel(typedArray, R.styleable.TVRelativeLayout_float_focus_marginBottom, 0);
