...
import com.quicktvui.support.ui.legacy.widget.TVTextView;
import com.quicktvui.support.ui.item.widget.BuilderWidget;
import com.quicktvui.support.ui.render.RenderNode;


public class TextHostView extends TVTextView implements ItemHostView {
    ...
    public TextHostView(Context context, int width, int height) {
        this(context,null);
        this.mPreferWidth = width;
        this.mPreferHeight = height;
    }

    public TextHostView(Context context) {
        this(context,null);
    }

    public TextHostView(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public TextHostView(Context context, AttributeSet attrs, int defStyleAttr) {
