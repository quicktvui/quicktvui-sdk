...
import com.quicktvui.support.ui.item.host.HostRootNode;
import com.quicktvui.support.ui.item.host.HostViewUtil;
...
import com.quicktvui.support.ui.render.RenderNode;
 ...
 class ItemSimpleHostView extends TVView implements ItemHostView {
    ...
    public ItemSimpleHostView(Context context, int width, int height) {
        this(context,null);
        this.mPreferWidth = width;
        this.mPreferHeight = height;
    }

    public ItemSimpleHostView(Context context) {
        this(context,null);
    }

    public ItemSimpleHostView(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public ItemSimpleHostView(Context context, AttributeSet attrs, int defStyleAttr) {
