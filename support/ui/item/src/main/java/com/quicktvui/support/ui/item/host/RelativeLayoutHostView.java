...
import com.quicktvui.support.ui.legacy.widget.TVRelativeLayout;
...
public class RelativeLayoutHostView extends TVRelativeLayout implements ItemHostView , DrawOrderBridge.BridgeView {
    ...
    public RelativeLayoutHostView(Context context) {
        super(context);
        init();
    }

    public RelativeLayoutHostView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public RelativeLayoutHostView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    public RelativeLayoutHostView(Context context, int width, int height) {
        super(context);                                                                  
...
//        Log.d("DrawOrderHostView","onSizeChanged h:"+h);
    ...
    protected void onFocusChanged(boolean gainFocus, int direction, Rect previouslyFocusedRect) {
        ...
        //如果再手动调取会有Widget多次被动调用onFocusChange的问题
        if(getRootNode() != null) {
            callFocusChange(getRootNode(), gainFocus);
        }
    }
