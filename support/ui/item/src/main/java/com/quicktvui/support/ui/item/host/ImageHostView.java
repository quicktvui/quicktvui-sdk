...
import com.quicktvui.support.ui.legacy.widget.TVImageView;
import com.quicktvui.support.ui.item.widget.BuilderWidget;
import com.quicktvui.support.ui.render.RenderNode;


public class ImageHostView extends TVImageView implements ItemHostView {
    ...
    public ImageHostView(Context context, int width, int height) {
        this(context,null);
        this.mPreferWidth = width;
        this.mPreferHeight = height;
    }

    public ImageHostView(Context context) {
        this(context,null);
    }

    public ImageHostView(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public ImageHostView(Context context, AttributeSet attrs, int defStyleAttr) {
