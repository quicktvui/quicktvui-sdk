...
@Deprecated
 public class DrawOrderHostView extends TVFrameLayout implements ItemHostView , DrawOrderBridge.BridgeView {
    ...
    public DrawOrderHostView(Context context) {
        super(context);
        init();
    }

    public DrawOrderHostView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public DrawOrderHostView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    public DrawOrderHostView(Context context, int width, int height) {
        super(context);
