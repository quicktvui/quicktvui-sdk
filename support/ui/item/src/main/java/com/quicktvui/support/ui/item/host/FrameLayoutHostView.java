...
public class FrameLayoutHostView extends TVFrameLayout implements ItemHostView , DrawOrderBridge.BridgeView {
    ...
    public FrameLayoutHostView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public FrameLayoutHostView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    public FrameLayoutHostView(Context context, int width, int height) {
        super(context);
