...
import quicktvui.support.lottie.manager.FontAssetManager;
import quicktvui.support.lottie.manager.ImageAssetManager;
...
import quicktvui.support.lottie.model.layer.CompositionLayer;
import quicktvui.support.lottie.parser.LayerParser;
import quicktvui.support.lottie.utils.Logger;
import quicktvui.support.lottie.utils.LottieThreadFactory;
import quicktvui.support.lottie.utils.LottieValueAnimator;
...
// </editor-fold>
    ...
    public void setUseCompositionFrameRate(boolean useCompositionFrameRate) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {//大于16api才支持
