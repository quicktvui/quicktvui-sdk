...
import static quicktvui.support.lottie.utils.Utils.closeQuietly;
...
import quicktvui.support.lottie.model.LottieCompositionCache;
import quicktvui.support.lottie.network.NetworkCache;
import quicktvui.support.lottie.parser.LottieCompositionMoshiParser;
...
public class LottieCompositionFactory {
  ...
  public static LottieTask<LottieComposition> fromJsonReader(final JsonReader reader, @Nullable final String cacheKey) {
    return cache(cacheKey, () -> fromJsonReaderSync(reader, cacheKey), () -> closeQuietly(reader));
  }
